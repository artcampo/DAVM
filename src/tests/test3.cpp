...
int main(){
  ...
  bc->stream = std::vector<uint32_t> {
    ...
    Comp( IR_REG3, IR_REG1, IR_REG2, IR_NOT),
    Comp( IR_REG4, IR_REG1, IR_REG2, IR_EQL),
    Comp( IR_REG5, IR_REG1, IR_REG2, IR_LST),
    Comp( IR_REG6, IR_REG1, IR_REG2, IR_LTE),
    
    Comp( IR_REG7, IR_REG1, IR_REG0, IR_EQL),
    Comp( IR_REG8, IR_REG1, IR_REG0, IR_LST),
    Comp( IR_REG9, IR_REG1, IR_REG0, IR_LTE),
